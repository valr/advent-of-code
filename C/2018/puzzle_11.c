...
void largest_total_power(int serial, int start_size, int end_size,
                         int *total_power, int *total_size, int *total_x,
                         int *total_y) {
  int x, y;
  int grid[301][301] = {};
  int rack, power;
...
int main(int argc, char **argv) {
  ...
  largest_total_power(5177, 3, 3, &total_power, &total_size, &total_x,
                      &total_y);
  printf("3x3 square with the largest total power: %d X,Y: %d,%d\n",
         total_power, total_x, total_y);

  largest_total_power(5177, 1, 300, &total_power, &total_size, &total_x,
                      &total_y);

...
int main(int argc, char **argv) {
  ...
  for (generation = 0; generation < 200; generation++) {
    ...
    printf("generation: %lld, sum of the numbers: %lld, diff with previous "
           "sum: %lld\n",
  ...
  /* from the previously displayed information, we can provide the results for
   * different generations */
  printf("part1, sum of the numbers after 20 generations: %lld\n",
         4818); /* 20th generation */
  printf(
      "part2, sum of the numbers after 50000000000 generations: %lld\n",
      16677 +
          ((50000000000 - 150) *
           102)); /* 150th generation + 5bi - 150 * diff between generations */
